# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-10-07 05:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Task',
        ...
        migrations.AddField(
            ...
            name='task',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student.Task'),
        ),
    ]
